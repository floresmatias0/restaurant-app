        ...
        <footer className="bg-[#784212] w-full">
            <div className="container mx-auto">
                <div className="py-6 sm:py-8 px-6">
                    <h3 className="text-white text-2xl md:text-lg py-2 sm:py-0 uppercase font-bold font-protest my-2">{data_contact?.title}</h3>
                ...
                <div className="w-full h-auto flex flex-col sm:flex-row gap-4 py-6 sm:py-8 px-6 text-white">
                    <div className="w-full h-full sm:w-1/2 sm:float-left">
                        <div className="my-4">
                            <h3 className="text-white text-2xl md:text-lg py-2 sm:py-0 uppercase font-bold font-protest">dirección</h3>
                            <p>- {data_contact?.address}</p>
                        </div>
                        <div className="my-4">
                            <h3 className="text-white text-2xl md:text-lg py-2 sm:py-0 uppercase font-bold font-protest">siguenos</h3>
                        ...
                        <div className="my-4">
                            <h3 className="text-white text-2xl md:text-lg py-2 sm:py-0 uppercase font-bold font-protest">contacto</h3>
